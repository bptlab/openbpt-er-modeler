  ...
  getPaletteEntries(element) {
    ...
    assign(actions, {
      ...
      'create-entity': createAction(
        `${MODELER_PREFIX}:Entity`, 'custom-elements', 'er-icon-entity', translate('Create entity')
      ),
      'create-relationship': createAction(
        `${MODELER_PREFIX}:Relationship`, 'custom-elements', 'er-icon-relationship', translate('Create relationship')
      ),
      'create-attribute': createAction(
        `${MODELER_PREFIX}:Attribute`, 'custom-elements', 'er-icon-attribute', translate('Create attribute')
      )
    });
    return actions;
  }
